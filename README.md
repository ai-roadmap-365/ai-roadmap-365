...
<p align="center">
  <img alt="lessons" src="https://img.shields.io/badge/lessons-140%20%2F%20365-1d4ed8">
  <img alt="labs" src="https://img.shields.io/badge/labs-140%20%2F%20365-4f46e5">
  <img alt="days complete" src="https://img.shields.io/badge/days%20complete-140%20%2F%20365-16a34a">
...
**140 of 365 days released.** Expand a course, then a subsection, to reach its lab and its published blog/course lesson URL. Fill URLs in `curriculum/published-urls.yml` (or set the deployment base with `npm run configure`), then re-run `npm run generate:section-nav`.
