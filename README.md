...
<p align="center">
  <img alt="lessons" src="https://img.shields.io/badge/lessons-110%20%2F%20365-1d4ed8">
  <img alt="labs" src="https://img.shields.io/badge/labs-110%20%2F%20365-4f46e5">
  <img alt="days complete" src="https://img.shields.io/badge/days%20complete-110%20%2F%20365-16a34a">
...
**110 of 365 days released.** Expand a course, then a subsection, to reach its lab and its published blog/course lesson URL. Fill URLs in `curriculum/published-urls.yml` (or set the deployment base with `npm run configure`), then re-run `npm run generate:section-nav`.
...
<details>
<summary><h3>Course03 · Math, Statistics, and Data — 12 lab(s)</h3></summary>
